...
//  
  ...
  glVertexAttribPointer(1, 3, GL_FLOAT, GL_FALSE, sizeof(struct a), (void*) (sizeof(float) * 4));
...
float old_camera_xrot = camera_xrot, old_camera_yrot = camera_yrot;
  ...
  if (glfwGetKey(window, GLFW_KEY_H) == GLFW_PRESS) camera_xrot -= 0.01;
  if (glfwGetKey(window, GLFW_KEY_J) == GLFW_PRESS) camera_yrot -= 0.01;
  if (glfwGetKey(window, GLFW_KEY_K) == GLFW_PRESS) camera_yrot += 0.01;
  if (glfwGetKey(window, GLFW_KEY_L) == GLFW_PRESS) camera_xrot += 0.01;
...
//  if (glfwGetKey(window, GLFW_KEY_E) == GLFW_PRESS) tra_z += 0.1;
  ...
  if (glfwGetKey(window, GLFW_KEY_SPACE) == GLFW_PRESS) {
    cube = glm::mat4(1.0);
    camera_xrot = 0.0; camera_yrot = 0.0;
